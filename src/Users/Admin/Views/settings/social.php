...
<div class="form-group">
    ...
    <div class="col-md-7">
        ...
        <fieldset>
            ...
            <label>Facebook enabled</label> <label class="radio-inline"> <input type="radio" name="social[providers][Facebook][enabled]" value="false" <?php if ($flash->old('social.providers.Facebook.enabled')) { echo "checked"; } ?>> False
            </label> <label class="radio-inline"> <input type="radio" name="social[providers][Facebook][enabled]" value="true" <?php if ($flash->old('social.providers.Facebook.enabled')) { echo "checked"; } ?>> True
            </label>
            <div>
        ...
        <fieldset>
            ...
            <label>Twitter enabled</label> <label class="radio-inline"> <input type="radio" name="social[providers][Twitter][enabled]" value="false" <?php if ($flash->old('social.providers.Twitter.enabled')) { echo "checked"; } ?>> False
            </label> <label class="radio-inline"> <input type="radio" name="social[providers][Twitter][enabled]" value="true" <?php if ($flash->old('social.providers.Twitter.enabled')) { echo "checked"; } ?>> True
            </label>
            <div>
